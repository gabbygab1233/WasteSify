...
import 'package:WasteSify/helpers/app_helper.dart';
import 'package:WasteSify/helpers/camera_helper.dart';
import 'package:WasteSify/helpers/tflite_helper.dart';
import 'package:WasteSify/models/result.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Image.asset('assets/icon/cameraheader.png', height: 40.0),
        centerTitle: true,
      ),
